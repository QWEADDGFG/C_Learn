...
# 45 "server.c"
                                    ;
    struct epoll_event * pEventArr = calloc(1024, sizeof(struct epoll_event));


    while(1) {
        int nready = epoll_wait(epfd, pEventArr, 1024, -1);
        if(nready == -1 && 
# 51 "server.c" 3 4
                          (*__errno_location ()) 
# 51 "server.c"
